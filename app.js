...
var addButton = document.querySelector('.todo__button_type_add');//first button
...
var editTask = function () {
  ...
  var editInput = listItem.querySelector('.todo__input-task');
  var label = listItem.querySelector('p');
  var editBtn = listItem.querySelector('.todo__button_type_edit');
  var containsClass = listItem.querySelector('.todo__text_hidden');
  ...
  if (containsClass) {
    ...
    label.classList.remove('todo__text_hidden');
    editInput.classList.remove('todo__input-task_visible');
    editBtn.innerText = 'Edit';
  } else {
    editInput.value = label.innerText;
    editInput.classList.add('todo__input-task_visible');
    label.classList.add('todo__text_hidden');
